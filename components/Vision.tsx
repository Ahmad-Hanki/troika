...
function Vision() {
  return (
    <>
      {/* section-1 */}
      <section className=" py-20 lg:py-32 border-t-2 border-textColorSec bg-white">
        <Container clas=" sm:px-8 md:px-12 lg:px-20 3xl:px-32 ">
          <div className="flex flex-col max-lg:space-y-24 lg:flex-row items-center justify-center justify-bewtween">
            <div className="flex flex-col space-y-12 lg:space-y-32 2xl:space-y-48 3xl:space-y-56 max-lg:justify-center max-lg:items-center max-lg:text-center">
      ...
      {/* section-2 */}
      <section className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 h-[110vh] sm:h-[120vh] lg:h-[80vh]">
